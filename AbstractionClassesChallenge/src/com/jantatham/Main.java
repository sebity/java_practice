...
//        list.traverse(list.getRoot());
        ...
        String stringData = "Luton London Birmingham Liverpool Manchester Sheffield Doncaster Oxford Cambridge";
...
//
//        list.traverse(list.getRoot());
//        list.removeItem(new Node("Liverpool"));
//        list.traverse(list.getRoot());
        ...
        tree.traverse(tree.getRoot());
        tree.removeItem(new Node("Liverpool"));
        tree.traverse(tree.getRoot());
    }
}
